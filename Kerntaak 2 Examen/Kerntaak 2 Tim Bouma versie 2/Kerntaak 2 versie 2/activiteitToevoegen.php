    ...
    <div class="container d-flex justify-content-center mt-3">
        <div class="row">
            <div class="col-sm-12 ">
                ...
                <form class="form-horizontal" action="includes/activiteitToevoegen.inc.php" method="post">
                    <div class="form-group row">
                        <label class="col-form-label col-sm-5">Naam activiteit: </label>
                        <input class="form-control col-sm-7" type="text" id="naam" name="naam" required>
                    </div>
                ...
                <?php
                      ...
                      elseif ($_GET["error"] == "activiteitExists") {
                        echo "Dit Activiteit bestaat al!";
                      }
                      ...
                      elseif ($_GET["error"] == "succes") {
                        echo "Succesvol een activiteit toegevoegd";
                      }
                    }
                 ?>
            </div>
