...
<html lang="en" dir="ltr">
  ...
  <!-- end navbar -->
    <h4 class="text-center">Activiteit Overzicht</h1>
        ...
        $conn->close();
        ?>
        <a href="generate_pdf_activiteit.php" class="btn col-sm-4" style="color: white; background-color: #219EBC;" name="generate_pdf" required>Print as PDF</a>
      </div>
        <!--end activiteiten ophalen-->
