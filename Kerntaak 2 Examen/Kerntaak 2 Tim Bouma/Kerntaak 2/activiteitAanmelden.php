          ...
          <div class="col-sm-12 ">
              ...
              <form class="form-horizontal" action="includes/activiteitAanmelden.inc.php" method="post">
                  <div class="form-group row">
                      <label class="col-form-label col-sm-4">JongerenId: </label>
                      <input class="form-control col-sm-8" type="text" id="jongerenId" name="jongerId"  required>
                  </div>
                  <div class="form-group row">
                      ...
                      <select class="form-control col-sm-8" type="text" id="activiteit" name="activiteit" required>
                        <option value="1">Cursus sociale vaardigheden</option>
                        <option value="2">Cursus communicatie vaardigheden</option>
                        <option value="3">Aanboord van een schip</option>
                        <option value="4">Survivaltocht</option>
                        <option value="Sportactiviteiten">Sportactiviteiten</option>
                      </select>
                  </div>
                  <div class="form-group row">
